...
function AddPicture(props) {
 ...
 return (
   <div className='flex flex-col p-2 border rounded-lg'>
     <div className='bg-yellow-100 min-h-40  relative cursor-pointer hover:bg-emerald-100'
       onClick={()=>document.getElementById('input-file').click()}
     >
       <input type="file" className='hidden' id='input-file' onChange={hdlFileChange} />
       {file && 
            <>
